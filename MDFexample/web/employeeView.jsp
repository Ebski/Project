    ...
    <body>
        <div class='container'>
            ...
            <div class="method pending-table">
                ...
                <div class="row margin-0">
                    <div class="col-md-1"><div class="cell">Tom</div></div>
                    <div class="col-md-3"><div class="cell">Tom</div></div>
                    <div class="col-md-2"><div class="cell">Tom</div></div>
                    <div class="col-md-2"><div class="cell">Tom</div></div>
                    <div class="col-md-2"><div class="cell">Tom</div></div>
                    <div class="col-md-2"><div class="cell">Tom</div></div>
                </div>
